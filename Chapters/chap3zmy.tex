...
\textbf{本章摘要：} 
%在无线网络基础设施飞速发展的今天，随着移动用户数量的爆炸式增长，无线频谱资源短缺的问题已经日益凸显出来。数据库辅助频谱共享技术则长期以来被视为解决频谱短缺问题颇有前景的解决方案之一，尽管其在用户位置隐私保护方面的不足一直给用户带来担忧和顾虑。
...
%博弈中次级用户作为策略性的玩家动态调整其策略，以最大化其社交群体效用。
...
参照文献[\citenum{Chenjournal}]，我们考虑一个具有社交意识的认知无线电网络（如图\ref{fg:domain}所示），其中每个次级用户在选择频道时都考虑了地理位置和社交关系所决定的双重网络外部性的影响。
